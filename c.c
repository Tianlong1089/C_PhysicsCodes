...
fprintf(gnuplot, "set multiplot layout 1,1 title 'Evolucion con Métedo Lax-Wendroff' \n");


fprintf(gnuplot, "set xlabel 'Posicion X' \n");
fprintf(gnuplot, "set ylabel 'Posicion U n+1' \n");
fprintf(gnuplot, "unset key \n");
fprintf(gnuplot, "plot 'cdata.txt' using 1:2 with lines lt 6  \n");
}
